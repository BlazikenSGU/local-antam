...
@section('content')
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            {{ Breadcrumbs::render('backend.warehouse.detail') }}
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-outline-info">
                    <div class="card-body">
                        <form class="form-horizontal my-custom-form" action="{{Route('backend.warehouses.detail',[$data_item->id])}}" method="POST">
                                    ...
                                    <div class="col-lg-12">
                                                                ...
                                                                <tr style="text-align: center;background: #fff;">
                                                                    ...
                                                                    <td style="border: 1px solid #eee;text-align: right"
                                                                        ...
                                                                        <span class="thanh-tien"
                                                                            data-thanh-tien="{{ $item->price }}">{{ number_format($item->price_after_discount * $item->quantity) }}</span>
                                                                        đ
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                        ...
                                        <p class="hide-print">
                                            ...
                                            <input type="button" value="Thoát"
                                                onclick="javascript:window.location='{{ route('backend.warehouses.index') }}'"
                                                class="btn btn-default" />
