...
{{--                                            </option>--}}
                                            ...
                                            <option value="4" {!! old('type')==4?'selected="selected"':'' !!}>
                                                Banner quảng cáo bên trái
                                            </option><option value="5" {!! old('type')==5?'selected="selected"':'' !!}>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="dropzone  col-md-12 " id="myDropzone2"
                                             action="">
                                            <div class="dz-message">
                                                <div>
                                                    <div class="message">
                                            ...
                                            <div class="result">
                                                @if($mobile_image_file)
                                                    <div class="thumb-nail-view">
                                                        <img src="{{$mobile_image_file->file_src}}"
                                                             class="img-thumbnail">
