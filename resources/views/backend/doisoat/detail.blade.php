    ...
    <div class="row page-titles desktop">
        <div class="col-md-12">
            <div class="card card-outline-info">
                <div class="card-body">
                    <div class="">
                        <a href="{{ route('backend.doi_soat.export') }}?id_doiSoat={{$idDoisoat}}" class="btn btn-info"><i
                                class="mdi mdi-file-excel"></i> Tải Excel</a>
                    </div>
                    ...
                    <div class="table-responsive mt-5">
                        <table class="table color-table muted-table table-striped" id="grid_table">
                            <thead>
                            <tr bgcolor="#f8f8f8"
                                style="font-weight:bold;height: 30px; line-height: 15px ">
                ...
                <div class="card card-outline-info">
                    <div class="card-body">
                        <div class="col-md-12">
                            ...
                            <p style="padding: 0; margin: 0">Tuỳ chọn thanh toán: {{ $item->payment_method == 2 ? 'Bên nhận trả phí' : ' Bên gửi trả phi' }} </p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-group-sm">
                                    <input type="text" name="date_start" value="" id="working_date_form" readonly=""
                                           class="form-control form-control-sm date_select" placeholder="Từ ngày"
                                           style="cursor: pointer;">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-group-sm">
                                    <input type="text" name="date_end" value="" id="working_date_to" readonly=""
                                           class="form-control form-control-sm date_select" placeholder="Đến ngày"
                                           style="cursor: pointer;">
                                </div>
                            </div>
                        </div>
