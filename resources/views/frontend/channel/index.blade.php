                        ...
                        <form action="{{ route('user.order.index') }}" method="GET" class="mb-4">
                            <div class="row g-3 " style="display: flex;justify-content: flex-end;">
                                ...
                                <div class="d-flex justify-content-end align-items-center">
                                    ...
                                    <a href="{{ route('user.order.index') }}" class="btn btn-secondary button_reset">
                            ...
                            <tbody>
                                @foreach ($orders as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="t-o">{{ number_format($item->cod_amount, 0, ',', '.') }}
                                                đ</span>
                                            <br>
                                        ...
                                        <td>
                                            <span
                                                class="t-b">{{ $item->payment_method == 2 ? 'Bên nhận' : 'Bên gửi' }}</span>
                                            <br>
                        ...
                        <div class="card" style="margin: 15px 0">
                            ...
                            <div class="card_info_3 d-flex flex-row justify-content-between align-items-center mt-1">
                                <div>
                                    ...
                                    <span class="t-b">{{ number_format($item->cod_amount, 0, ',', '.') }} vnđ</span>
                                </div>
