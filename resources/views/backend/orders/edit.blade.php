                            ...
                            <form class="form-horizontal" action="" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <h4 class="font-weight-bold" style="color: #1b3d94">Đơn hàng giao 1
                                            phần: {{ $order->PartialReturnCode }} </h4>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control form-control-line to_phone"
                                                       name="phone"
                                                       onchange="UpdateOrder({{$order->id}})" {{$isCheckAddress}}
                                                       required value="{{old('to_phone', $order->to_phone)}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12 font-weight-bold">Họ tên</label>
                                            <div class="col-md-12">
                                                <input type="text" class="form-control form-control-line to_username"
                                                       name="username" {{$isCheckAddress}}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-md-12 font-weight-bold">Địa chỉ</label>
                                            <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold">Tỉnh thành <span
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold">Quận huyện <span
                                                        class="text-danger">*</span></label>
                                                <select
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold">Phường xã <span
                                                        class="text-danger">*</span></label>
                                                <select
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-1">
                                            @if(empty($isCheckAddProduct))
                                                <p class="btn_add_newProduct1 badge"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="col-md-12 font-weight-bold">Dài</label>
                                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="col-md-12 font-weight-bold">Rộng</label>
                                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="col-md-12 font-weight-bold">Cao</label>
                                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class=" ">
                                            ...
                                            ?>
                                            <strong class="col-md-12 font-weight-bold">Khối lượng tính cước: <?=$weight?></strong>
                                        </div>
                                        <div class=" ">
                                            <label
                                                class="col-md-12 font-weight-bold">@if(!empty($order->ConvertedWeight))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-md-12 font-weight-bold">Thu hộ</label>
                                            <div class="col-md-12">
                                                ...
                                                <input type="text"
                                                       ...
                                                       onkeyup="UpdateOrder({{$order->id}})" {{ $isCheckNote }}
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12 font-weight-bold">Giá trị đơn hàng</label>
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12 font-weight-bold">Thu tiền khi giao hàng thất
                                                bại</label>
                                            <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control form-control-sm" name="note"
                                                          ...
                                                          {{ $isCheckNote }} onchange="UpdateOrder({{$order->id}})"
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-4">
                                                {{--                                                <h5> <span class="font-weight-bold" style="color: #F26522">Vận chuyển : </span><strong class="total_fee">--}}
                                                {{--                                                        --}}{{--                                                        @if($order->main_service > 0)--}}
                                                {{--                                                        --}}{{--                                                           --}}
                                                {{--                                                        --}}{{--                                                        @else--}}
                                                {{--                                                        --}}{{--                                                            0 vnđ--}}
                                                {{--                                                        --}}{{--                                                        @endif--}}
                                                ...
                                                {{--                                                <h5> <span class="font-weight-bold" style="color: #F26522">Khai giá : </span>--}}
                                                {{--                                                    <strong class="insurance_fee">{{ number_format($order->insurance_fee) }} </strong></h5>--}}
                                                    ...
                                                    <div class="col-4 col-md-3 text-right">
                                                        <strong class="insurance_fee">
                                                            @if(!empty($order->insurance_fee))
                                                                {{ number_format($order->insurance_fee ,0, ',', '.') }}
                                                            @else
                                                                0
                                                            @endif
                                                        </strong>
                                                ...
                                                {{--                                                <ul style="text-decoration: none;     list-style: none;">--}}
                                                {{--                                                    <li>Phí giao lại hàng: {{ $order->R2S }}</li>--}}
                                                {{--                                                    <li>Phí hoàn hàng: {{ $order->Return_k }}</li>--}}
                                                {{--                                                    <li>Phí hoàn hàng lần nữa : {{ $order->ReturnAgain }} </li>--}}

                                                {{--                                                </ul>--}}

                                                {{--                                                <h5> <span class="font-weight-bold" style="color: #F26522">Giao lại : </span>--}}
                                                {{--                                                    <strong class="insurance_fee">{{ number_format($order->R2S) ?? 0 }} </strong></h5>--}}


                                                <h5 class="row">
                                                    <div class="col-8 col-md-7 row">
                                                        <span class="font-weight-bold col-10 col-md-10 text-left"
                                                              style="color: #F26522">Giao lại</span>
                                                        <span class="font-weight-bold col-2 col-md-2"
                                                              style="color: #F26522">:</span>
                                                    </div>
                                                    <div class="col-4 col-md-3 text-right">
                                                ...
                                                {{--                                                <h5> <span class="font-weight-bold" style="color: #F26522">Hoàn hàng : </span>--}}
                                                {{--                                                    <strong class="insurance_fee">{{ number_format($order->Return_k) ?? 0 }} </strong></h5>--}}


                                                <h5 class="row">
                                                    <div class="col-8 col-md-7 row">
                                                        <span class="font-weight-bold col-10 col-md-10 text-left"
                                                              style="color: #F26522">Hoàn hàng</span>
                                                        <span class="font-weight-bold col-2 col-md-2"
                                                              style="color: #F26522">:</span>
                                                    </div>
                                                    <div class="col-4 col-md-3 text-right">
                                                        <strong class="">
                                                            @if(!empty($order->Return_k))
                                                                {{ number_format($order->Return_k,0, ',', '.') }}
                                                            @else
                                                                0
                                                            @endif
                                                        </strong>
                                                ...
                                                {{--                                                <h5> <span class="font-weight-bold" style="color: #F26522">Giao hàng 1 phần : </span>--}}
                                                {{--                                                    <strong class="insurance_fee">{{ number_format($order->phi_gh1p) ?? 0 }} </strong></h5>--}}


                                                <h5 class="row">
                                                    <div class="col-8 col-md-7 row">
                                                        <span class="font-weight-bold col-10 col-md-10 text-left"
                                                              style="color: #F26522">Giao hàng 1 phần</span>
                                                        <span class="font-weight-bold col-2 col-md-2"
                                                              style="color: #F26522">:</span>
                                                    </div>
                                                    <div class="col-4 col-md-3 text-right">
                                                        <strong class="">
                                                            @if(!empty($order->phi_gh1p))
                                                                {{--                                                                {{$order->phi_gh1p,0, ',', '.'}}--}}
                                                                {{ number_format((int) str_replace(['.', ','], '', $order->phi_gh1p),0, ',', '.')  }}
                                                            @else
                                                                0
                                                            @endif
                                                        </strong>
                                                ...
                                                {{--                                                <h5> <span class="font-weight-bold" style="color: #F26522">Tổng Phí : </span><strong class="total_cost">--}}
                                                {{--                                                        --}}{{--                                                        @if(!empty($order->total_cost))--}}
                                                {{--                                                        --}}{{--                                                            {{$order->total_cost}}--}}
                                                {{--                                                        --}}{{--                                                        @else--}}
                                                {{--                                                        --}}{{--                                                            {{ number_format($order->total_fee) }} vnđ--}}
                                                {{--                                                        --}}{{--                                                        @endif--}}
                                                ...
                                                <h5 class="row">
                                                    ...
                                                    <div class="col-4 col-md-3 text-right">
                                                        <strong class="total_cost">
                                                            @if(!empty($order->main_service))
                                                                <?php
                                                                        $main_service_str = (string) $order->main_service;

                                                            // Tìm phần sau dấu thập phân
                                                                        $parts = explode('.', $main_service_str);
                                                                        $decimal_part = isset($parts[1]) ? $parts[1] : '';
                                                                        ?>
                                                            @if (strlen($decimal_part) === 1)
                                                                {{number_format((int) floor($order->main_service) + 1, 0, ',', '.')}}
                                                                @else
...
{{--                                        <button class="btn btn-secondary btncheckPrice" type="button">Xem giá</button>--}}
                                        @if(empty($order->order_code))
                                            <button class="btn btn-info btnConfirmOrder"
                                                    data-order-id="{{ $order->id }}" type="button">Lưu
                                            </button>
                                        @else
...
@section('script')
    ...
    <script>
        var StrOrderCode = `{{ $order->order_code }}`;
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", ".btn_add_newProduct1", function () {
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="number" class="form-control quantity product_quantity_${data.e.id}" name="product_quantity[]"
                                                               placeholder="Số lượng sản phẩm" onchange="updateDetail(${data.e.id})" value="1"
                                                               aria-describedby="basic-addon1">
                                                    </div>
                                                </div>
                                                <div class="col-md-1 mobile">
            ...
            $(document).on("change", ".productVoluem", function () {
                ...
                if (parseInt(val) < 1) {
                    Swal.fire({
                        text: "Vui lòng kiểm tra khối lượng nhỏ nhất là 1g.",
                        icon: "info",
                    }).then((result) => {
                        window.location.reload()
                    });
                        ...
                        success: function (data) {
                            ...
                            if (data.r.r === 1) {
                                ...
                                Swal.fire({
                                    ...
                                    {{--window.location.href = '{{ route('backend.orders.orderscheckout', $order->id ) }}';--}}
                                });
                            }
                        }
                    });
        ...
        function changePriceCost(val, weight) {
            ...
            $.ajax(settings).done(function (response) {
                ...
                //total_cost = total_cost.toLocaleString('it-IT', {style: 'currency', currency: ''});
