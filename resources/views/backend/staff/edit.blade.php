                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @php
                                                                    ...
                                                                    $bankName =
                                                                        $banks[$user->bank_name] ?? $user->bank_name;
                                                                @endphp
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="account_type" id="type_customer">
                                                <option value=""
                                                    {{ isset($user->account_type) && $user->account_type > 0 ? 'disabled' : '' }}>
                                                    -Chọn-
                                                </option>
                                                <option value="1" {{ $user->account_type == 1 ? 'selected' : '' }}>Tạo
                                                    đơn
                                                    thủ công</option>
                                                <option value="2" {{ $user->account_type == 2 ? 'selected' : '' }}>
                                                    Kênh quản
                                                    lý
                                                    bán
                                                    hàng
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-control-line" name="status">
                                                    ...
                                                    <option value="{{ \App\Models\CoreUsers::STATUS_REGISTERED }}"
                                                        {!! $form_init->status == \App\Models\CoreUsers::STATUS_REGISTERED ? 'selected="selected"' : '' !!}>
                                                        Đang hoạt động
                                                    </option>
                                                    <option value="{{ \App\Models\CoreUsers::STATUS_NEWACCOUNT }}"
                                                        {!! $form_init->status == \App\Models\CoreUsers::STATUS_NEWACCOUNT ? 'selected="selected"' : '' !!}>
                                                        Tài khoản mới
                                                    </option>
                                                    <option value="{{ \App\Models\CoreUsers::STATUS_BANNED }}"
                                                        {!! $form_init->status == \App\Models\CoreUsers::STATUS_BANNED ? 'selected="selected"' : '' !!}>
                                                        Đã bị cấm
                                                    </option>
                                                </select>
                                            </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-check">
                                                        ...
                                                        <label for="shop_{{ $branch->shopId }}" class="form-check-label">
                                                            <span
                                                                class="badge {{ $branch->type == 2 ? 'bg-success' : 'bg-danger' }}">
                                                                {{ $branch->shopId }}</span> –
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-primary" onclick="submitShopIds()">Gán
                                            shopId</button>
                                    </div>
