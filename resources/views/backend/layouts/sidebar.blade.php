<li class="menu-item {{ request()->routeIs('backend.orders.*') ? 'active' : '' }}">
    <a href="{{ route('backend.orders.index') }}" class="menu-link">
        ...
        <div class="text-truncate" data-i18n="Basic">Đơn hàng</div>
    </a>
</li>

<li class="menu-item {{ request()->routeIs('backend.doi_soat.*') ? 'active' : '' }}">
    <a href="{{ route('backend.doi_soat.index') }}" class="menu-link">
        <i class="menu-icon tf-icons bx bx-file"></i>
        <div class="text-truncate" data-i18n="Basic">Đối soát</div>
    </a>
</li>

<li class="menu-item {{ request()->routeIs('backend.staff.*') ? 'active' : '' }}">
    <a href="{{ route('backend.staff.index') }}" class="menu-link">
        <i class="menu-icon tf-icons bx bx-user"></i>
        <div class="text-truncate" data-i18n="Basic">Tài khoản</div>
    </a>
</li>

<li class="menu-item {{ request()->routeIs('backend.brands.*') ? 'active' : '' }}">
    <a href="{{ route('backend.brands.index') }}" class="menu-link">
        <i class="menu-icon tf-icons bx bx-store-alt"></i>
        <div class="text-truncate" data-i18n="Basic">ShopId</div>
    </a>
</li>

<li class="menu-item {{ request()->routeIs('backend.notification.*') ? 'active' : '' }}">
    <a href="{{ route('backend.notification.index') }}" class="menu-link">
        <i class="menu-icon tf-icons bx bx-cube-alt"></i>
        <div class="text-truncate" data-i18n="Basic">Webhook</div>
    </a>
</li>
