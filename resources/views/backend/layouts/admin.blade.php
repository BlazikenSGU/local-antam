            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('backend.dashboard') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2" style="font-size: 16px;">An Tâm
                            Ecommerce</span>
                    </a>
            ...
            <div class="layout-page">
                ...
                <nav class="layout-navbar container-fluid navbar-detached navbar navbar-expand-xl align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
                        <div>
                            <h3 style="color: #1b4e87;font-weight: bold;font-size: 18px;margin: 0">
                                @yield('page_title')
                            </h3>
                        </div>
