                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <a class="btn rounded-pill btn-outline-primary" href="{{ route('backend.orders.index') }}"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <form action="{{ route('backend.orders.search') }}" method="GET" style="margin-left: .5rem">
                                <div class="input-group">
                                    <select class="form-select" id="inputGroupSelect04" name="status" id="statusSelect2"
                                        aria-label="Example select with button addon">
                                        <option value="" selected {{ request('status') ? 'disabled' : '' }}>
                                ...
                                @foreach ($orders as $key => $item)
                                    <tr>
                                        <td>
                                            ...
                                            <br>
                                            <span class="badge rounded-pill bg-danger">{{ $item->shop_id }}</span>
                                            <br>
