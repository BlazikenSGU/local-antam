...
class GHN
{
    // protected static $token = 'fcdb09d8-b9e1-11ee-962e-3e7deb519ac3';
    // protected static $token = '7bb01781-4af7-11ed-b824-262f869eb1a7';
    ...
    public static function Order($data, $externalItems)
    {
        try {
            ...
            $body = [
                ...
                "coupon"=> null,
                "items" => $externalItems,
                "cod_failed_amount" => (int)$data['cod_failed_amount'],
